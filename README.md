...
-- server-side routing required frequests from a server for one page’s worth of content
-- Client-side routing requires usually just one request from the server of most or all the data needed. This allows us to simply update what the screen is showing rather than needed to send another request to change pages.

- [ ] What does HTTP stand for?
-- HyperText Transfer Protocol or simply a rule set for how to communicate with servers.

- [ ] What does CRUD stand for?
-- Create, Read, Update, and Delete which are http methods for how interact with a server.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
-- Get, Head, Post, Put, Patch, Delete

-- Axios, JQuery, SuperAgent
